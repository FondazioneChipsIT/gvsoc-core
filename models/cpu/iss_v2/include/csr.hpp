...
public:
    ...
    void register_callback(std::function<bool(iss_insn_t *, bool, iss_reg_t &)> callback);
    bool access(iss_insn_t *insn, bool is_write, iss_reg_t &value);
...
private:
    std::vector<std::function<bool(iss_insn_t *, bool, iss_reg_t &)>> callbacks;
