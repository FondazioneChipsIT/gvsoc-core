...
public:
    ...
    // purpose: the co-simulation bridge restores hwloop state through them
    // and, living in a separate shared object, can only call what inlines
    // (the model library does not export its symbols to the bridge).
